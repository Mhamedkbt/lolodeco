          ...
          <aside className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              <div className="rounded-xl border border-gray-100 bg-white p-6 shadow-lg">
                ...
                <a
                  href={`https://wa.me/212661141811?text=Hello, I'm interested in the property: ${encodeURIComponent(property.title ?? '')} - ${encodeURIComponent(`localhost:3000/properties/${property.id}`)}`}
                  target="_blank"
